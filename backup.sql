...
INSERT INTO `friends` VALUES (36,1,6);
...
INSERT INTO `groups_members` VALUES (42,1,17),(43,1,16),(44,1,1),(45,6,1),(47,19,1),(48,20,1),(49,16,1),(50,1,19),(51,1,20);
...
INSERT INTO `user_login` VALUES (27,'aYirVv5HK5ncXhpD',1),(31,'H8SUfwwXQplyqkbN',1),(32,'lcoGw5Q4Qlj2D1TC',1),(33,'ACS9o9yXTHu0oUhs',1),(39,'DHbOq4YzqrDJOOpZ',1),(40,'cN6fwezzxiuAGf6h',1),(42,'B492OhWCKfQKH6mL',21),(43,'mdARUe4LMF1GMbzw',1),(44,'B87Ppe99V2TH6iWV',16),(45,'mL0Vyx1AxYGfWPPC',1),(47,'N4DLDMtjEFaGUzLY',1);
...
begin
	insert into users (username, email, password, profile_img, banner_img, created_at, description) 
values(username_input, email_input, password_input, profile_img_input, banner_img_input, (curdate()), description_input);
commit;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
BEGIN
  ...
  INSERT INTO groups (group_token, group_owner_id, banner_img, description, created_at, name, profile_img)
  VALUES (group_token_input, group_owner_id_input, banner_img_input, description_input, (curdate()), name_input, profile_img_input);

  SET @new_group_id = LAST_INSERT_ID();

  INSERT INTO groups_members (member_id, group_id) VALUES (group_owner_id_input, @new_group_id);
...
-- Dump completed on 2023-07-24 20:00:42
